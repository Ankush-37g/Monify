...
const Sidebar = () => {
  ...
  return (
    ...
    <div className=" w-full h-full bg-gradient-to-b from-green-400 to-green-700  shadow-xl p-6 flex flex-col justify-between transition-all duration-300">

      {/* Profile Section */}
       <div className="flex flex-col items-center p-4">

        <div className="relative w-24 h-24 mb-4 rounded-full bg-white border-4 border-gray-200 overflow-hidden shadow-lg">
                  ...
                  <li key={index} >
                      ...
                      <Link to={`/${item.name}`}
                        ...
                        className={`flex items-center space-x-4 p-3 rounded-xl transition-colors duration-200 
                          ${isActive ? 'bg-green-900 text-white shadow-md' : 'text-green-100 hover:bg-green-800'}`}
                      >
